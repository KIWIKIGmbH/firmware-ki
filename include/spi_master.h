 ...
 * @return
 * @retval true if transmit/receive of transfer_size were completed.
 * @retval false if transmit/receive of transfer_size were not complete and tx_data/rx_data points to invalid data.
 */
